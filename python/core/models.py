...
class Joker:
    ...
    def _build_id(self):
        ...
        val = (val << 5) | (self.joker_edition & 0b111)
        self.joker_id = val
    ...
    @override
    def __repr__(self):
        base = self.joker_name.name.lower()
        if self.joker_edition != JokerEdition.NONE:
            base = f"{self.joker_edition.name.lower()} {base}"
